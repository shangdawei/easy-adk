...
/* This is a demo activity for using the EasyADKBackport library */

public class ADKBackportDemoActivity extends Activity {
	Handler UIHandler = new Handler();
	EasyAdkConnection AdkConnection;
	TextView textbox;
	
	static final String TAG = "EasyADKBackport";
...
//		System.exit(0);
	...
	public class EasyAdkConnection extends EasyADKBackport{
